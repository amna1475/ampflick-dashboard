...
export default function RevenueLineChart() {
  const growth = (
    ((monthlyRevenue.at(-1).revenue - monthlyRevenue.at(-2).revenue) / monthlyRevenue.at(-2).revenue) *
    100
  ).toFixed(0)
  ...
  return (
    <div className="rounded-2xl bg-white border border-slate-100 shadow-card p-5 h-full flex flex-col">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs font-semibold text-emerald-600">↗ {growth}% growth vs last month</span>
      </div>
