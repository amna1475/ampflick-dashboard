...
import { paymentMethods, paymentOverview } from '../data/mockData'

const STATS = [
  { label: 'Total Received', value: `Rs ${paymentOverview.received}`, tone: 'text-emerald-600 bg-emerald-50' },
  { label: 'Pending Payments', value: `Rs ${paymentOverview.pending}`, tone: 'text-amber-600 bg-amber-50' },
  { label: 'Refunded', value: `Rs ${paymentOverview.refunded}`, tone: 'text-rose-600 bg-rose-50' },
]
      ...
      <div className="mt-5 flex flex-col sm:flex-row items-center gap-5">
        <div className="h-40 w-40 shrink-0">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={paymentMethods} dataKey="value" nameKey="name" innerRadius="55%" outerRadius="90%" paddingAngle={2}>
